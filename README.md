...
9. If a method requires an ID, first run the get method to retrieve all the records and then copy and paste the Id you are interested in, into the id field. The execute the method to view te results.
## Reference list:
